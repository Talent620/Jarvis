...
| B-043 | Software factory roles, cost router, reviewer loop, coder acceptance | M13 | done | src/node/coder/, scripts/ | paying twice | fake roles, acceptance fake/local | codex mode = needs_hardware |
