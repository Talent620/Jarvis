...
// Hasło aplikacji Gmail (lub dane innego SMTP) podaje użytkownik w ustawieniach;
// nic nie wychodzi nigdzie poza wskazany serwer pocztowy.
const tls = require("net") && require("tls");

function smtpSend({ host, port, user, pass, to, subject, body }) {
